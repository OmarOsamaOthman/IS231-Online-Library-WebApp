...
// ── Get form inputs (Django renders them as id_fieldname) ──
...
// ── Seed preview with current values from the form ──
...
// للصورة الحالية
const currentImage = document.querySelector(".current-cover-url");
if (currentImage) previewCover.src = currentImage.dataset.src;
